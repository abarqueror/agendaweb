...
/**
 * Servlet implementation class ServletActividadGetByIdUsuario
 */
@WebServlet("/ServletActividadGetByIdUsuario")
public class ServletActividadGetByIdUsuario extends HttpServlet {
     ...
     */
    public ServletActividadGetByIdUsuario() {
        super();
