...
public class ServletUsuarioLogout extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		//vid 43- p 18
		//Si existe la sesion la elimina
		HttpSession httpSession = request.getSession();
		
		httpSession.removeAttribute("idUsuario");
		httpSession.removeAttribute("correoElectronico");
		
		//redirecciono a lo configurado en el webxml-> ServletUsuarioLogin
		response.sendRedirect("/appwebagenda");
